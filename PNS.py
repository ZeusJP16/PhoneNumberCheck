...
class Location_Tracker:
    def __init__(self, App):
        ...
        self.window.configure(bg="#4A83FA")
        self.window.resizable(False, False)

        #___________Application menu_____________
        Label(App, text="Enter a phone number",fg="white", font=("Times", 20), bg="#4A83FA").place(x=150,y= 30)
        self.phone_number = Entry(App, width=16, font=("Arial", 15), relief="flat")
        self.track_button = Button(App, text="Track Country", fg="green", bg="#59E0D5", relief="sunken")
        self.country_label = Label(App,fg="white", font=("Times", 20), bg="#4A83FA")
